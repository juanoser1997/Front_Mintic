...
const datosTabla = data.getProjectId.avances.map(
  (avance) => (
    <Fragment>
        <Accordion>
          <Accordion.Item eventKey="0">
           ...
           <b> Observaciones del Lider :</b> {avance.observaciones_lider}
              ...
              <ListGroup.Item as="li">
            <b> Fecha de Avance :</b>  {new Date(avance.fecha_avance).toLocaleDateString()}
               </ListGroup.Item>
              
             
            <Link to={"/registrar-observacion"}>  <Button style={{ width:'100%' }} variant="dark"  onClickCapture={(e, id) => { handleRegistrar(avance.id_avance); }} > Agregar observacion</Button></Link> 
    ...
    return ( 
        ...
        {(context) => {
          ...
          return (
           ...
           <h2 className="te"  style={{ textAlign:'center',marginTop:'3%' }} >Avances proyecto {data.getProjectId.nombre} </h2>
            ...
            <Link to={'/misproyectos-lider'}> <Button   style={{ marginLeft :'43%' }}  variant="dark">volver </Button></Link> 
