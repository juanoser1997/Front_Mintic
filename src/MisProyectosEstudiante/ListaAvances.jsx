    ...
    return ( 
        ...
        {(context) => {
          ...
          return (
           ...
           <h2 className="te" style={{ textAlign:'center' }} >Mis Avances</h2>
         <Link to="/formulario-avance">  <Button variant="dark" style={{ marginLeft:'11%', borderRadius:'10px' }} > Nuevo Avance </Button></Link> 
